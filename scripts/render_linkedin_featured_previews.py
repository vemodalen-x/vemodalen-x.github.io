...
def render_card(
    ...
    draw.text(
        (68, 536),
        "Reliable AI  |  Multimodal Systems  |  Computer Vision  |  Edge AI",
...
def main() -> None:
    ...
    cards = [
        (
            ...
            ("Tested Workflow", "Reference"),
            "Provider-neutral Python reference for validated outputs, retry, fallback, confidence gates, traces, and hard-case evaluation.",
            TEAL,
        ),
        (
