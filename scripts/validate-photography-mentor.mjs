...
assert(/href="PRIVACY\.md"/.test(html) && /href="TERMS\.md"/.test(html), "commercial-policy-links", "privacy and terms are linked in-app");
assert(!/href="(?:work|writing)\.html"/.test(html), "standalone-navigation", "no portfolio-only navigation");
