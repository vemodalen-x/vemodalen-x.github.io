...
- **70 个交互节点**：核心训练集，回答“今天产生什么可检查证据”；其中 7 个 AFD 节点建立 Agent/FDE 交付主干，9 个 FDE26 节点把 recruiter/硬闸门、pair build、企业集成、ACL-first RAG、受限部署、事故、ROI、平台复用和 EP/offer 变成可评分证据，3 个 Kimi K3 节点连接前沿模型架构、Agent 后训练与百万上下文 serving。
