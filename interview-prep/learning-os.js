(function () {
  ...
  var PRINCIPLE_TASK_IDS = {
    P1: ['k1-positioning', 'k1-project-depth', 'k1-failure', 'k1-agent-fde-positioning', 'k3-metrics', 'k5-bokeh', 'k8-fullstack-release', 'k8-rag-eval', 'k8-agent-evaluation', 'k8-hello-agent-capstone', 'k8-prompt-contract', 'k8-prompt-eval-loop', 'k8-kimi-k3-agent-training', 'k8-kimi-k3-serving-audit', 'k8-fde-discovery', 'k8-agent-architecture-choice', 'k8-fde-eval-pilot', 'k8-fde-production-rollout', 'k8-fde-live-case'],
    P2: ['k2-covariance', 'k2-softmax', 'k3-leakage', 'k5-conv', 'k5-dice', 'k5-neural-fields', 'k5-view-synthesis', 'k6-parity', 'k7-binary-search', 'k7-graph', 'k7-fde-existing-system', 'k8-transformer', 'k8-masked-attention', 'k8-smol-sft', 'k8-smol-dpo', 'k8-smol-vlm', 'k8-sensenova-unified', 'k8-sensenova-eval-runtime', 'k8-kimi-k3-architecture', 'k8-rag-eval', 'k8-context-harness', 'k8-agent-architecture-choice', 'k8-fde-eval-pilot'],
    P3: ['k2-bias-variance', 'k2-softmax', 'k4-adam', 'k4-batchnorm', 'k4-training-debug', 'k5-conv', 'k5-neural-fields', 'k5-view-synthesis', 'k7-binary-search', 'k7-graph', 'k7-fde-existing-system', 'k8-distributed-replicated-log', 'k8-transformer', 'k8-smol-sft', 'k8-smol-dpo', 'k8-smol-vlm', 'k8-sensenova-unified', 'k8-kimi-k3-architecture', 'k8-agent-loop', 'k8-hello-agent-patterns', 'k8-agent-architecture-choice', 'k8-fde-live-case'],
    P4: ['k3-drift', 'k4-batchnorm', 'k5-temporal', 'k6-queue', 'k7-lru', 'k7-fullstack-vertical-slice', 'k7-fde-existing-system', 'k8-fullstack-release', 'k8-distributed-replicated-log', 'k8-distributed-idempotency', 'k8-kimi-k3-agent-training', 'k8-kimi-k3-serving-audit', 'k8-agent-loop', 'k8-hello-agent-patterns', 'k8-context-harness', 'k8-harness-three-layers', 'k8-coding-agent', 'k8-harness-repo-map', 'k8-harness-backpressure', 'k8-harness-feedback', 'k8-agent-safety', 'k8-multi-agent', 'k8-agent-architecture-choice', 'k8-fde-production-rollout', 'k8-fde-live-case'],
    P5: ['k3-leakage', 'k6-parity', 'k6-queue', 'k7-fullstack-vertical-slice', 'k7-fde-existing-system', 'k8-fullstack-release', 'k8-distributed-idempotency', 'k8-masked-attention', 'k8-smol-sft', 'k8-smol-vlm', 'k8-sensenova-unified', 'k8-kimi-k3-agent-training', 'k8-kimi-k3-serving-audit', 'k8-rag-eval', 'k8-agent-loop', 'k8-hello-agent-patterns', 'k8-context-harness', 'k8-harness-three-layers', 'k8-coding-agent', 'k8-harness-repo-map', 'k8-harness-backpressure', 'k8-agent-safety', 'k8-prompt-contract', 'k8-multi-agent', 'k8-fde-discovery', 'k8-agent-architecture-choice', 'k8-fde-eval-pilot', 'k8-fde-production-rollout', 'k8-fde-live-case'],
    P6: ['k2-bias-variance', 'k2-covariance', 'k2-softmax', 'k3-leakage', 'k3-metrics', 'k3-drift', 'k4-training-debug', 'k5-dice', 'k5-bokeh', 'k5-temporal', 'k5-neural-fields', 'k5-view-synthesis', 'k6-parity', 'k6-latency', 'k7-graph', 'k8-fullstack-release', 'k8-distributed-replicated-log', 'k8-distributed-idempotency', 'k8-smol-sft', 'k8-smol-dpo', 'k8-smol-vlm', 'k8-sensenova-eval-runtime', 'k8-kimi-k3-architecture', 'k8-kimi-k3-agent-training', 'k8-kimi-k3-serving-audit', 'k8-rag-eval', 'k8-hello-agent-patterns', 'k8-agent-evaluation', 'k8-hello-agent-capstone', 'k8-harness-feedback', 'k8-agent-safety', 'k8-prompt-eval-loop', 'k8-fde-discovery', 'k8-agent-architecture-choice', 'k8-fde-eval-pilot', 'k8-fde-production-rollout', 'k8-fde-live-case'],
    P7: ['k4-mixed-precision', 'k5-bokeh', 'k5-view-synthesis', 'k6-latency', 'k6-queue', 'k7-lru', 'k7-fullstack-vertical-slice', 'k7-fde-existing-system', 'k8-fullstack-release', 'k8-distributed-replicated-log', 'k8-distributed-idempotency', 'k8-transformer', 'k8-smol-sft', 'k8-smol-dpo', 'k8-smol-vlm', 'k8-sensenova-unified', 'k8-sensenova-eval-runtime', 'k8-kimi-k3-architecture', 'k8-kimi-k3-agent-training', 'k8-kimi-k3-serving-audit', 'k8-rag-eval', 'k8-context-harness', 'k8-harness-three-layers', 'k8-coding-agent', 'k8-harness-backpressure', 'k8-agent-evaluation', 'k8-hello-agent-capstone', 'k8-harness-feedback', 'k8-agent-safety', 'k8-prompt-eval-loop', 'k8-multi-agent', 'k8-agent-architecture-choice', 'k8-fde-eval-pilot', 'k8-fde-production-rollout', 'k8-fde-live-case'],
    P8: ['k1-positioning', 'k1-project-depth', 'k1-failure', 'k1-agent-fde-positioning', 'k3-metrics', 'k5-bokeh', 'k6-latency', 'k7-fde-existing-system', 'k8-fullstack-release', 'k8-distributed-idempotency', 'k8-kimi-k3-agent-training', 'k8-kimi-k3-serving-audit', 'k8-agent-loop', 'k8-harness-three-layers', 'k8-coding-agent', 'k8-harness-repo-map', 'k8-agent-evaluation', 'k8-hello-agent-capstone', 'k8-harness-feedback', 'k8-agent-safety', 'k8-prompt-contract', 'k8-prompt-eval-loop', 'k8-multi-agent', 'k8-fde-discovery', 'k8-fde-eval-pilot', 'k8-fde-production-rollout', 'k8-fde-live-case']
  };
  ...
  var TASKS = [
    ...
    {
      id: 'k8-kimi-k3-architecture', cluster: 'K8', title: 'Kimi K3 KK3-1/2/3：Hybrid Attention、AttnRes 与 Stable LatentMoE', kind: 'explain', duration: 55, week: 5, prereqs: ['k8-transformer'],
      goal: '从 sequence、depth、width、modality 四轴解释 K3，并把信息流、状态、shape、数值范围和资源代价连起来。', output: '四轴架构图 + KDA/MLA state table + AttnRes/LatentMoE 数据流 + 90 秒答案。',
      prompt: '为什么 K3 使用 3 KDA + 1 Gated MLA，而不是全 KDA 或全 MLA？AttnRes 与 Stable LatentMoE 又分别改变哪一维信息流？',
      construct: '画 93 层主干的重复单元；写 KDA fixed state、MLA latent KV、AttnRes block representation 与 latent expert 的 shape/生命周期/成本。推导 16-token tile 的有界 decay 与 BF16 范围，并说明 QB bias 为何只影响 dispatch。',
      transfer: '把上下文缩到 8K、设备换成 memory-rich 但 compute-poor GPU、needle retrieval 权重提高。你会保留、替换或重新配比哪些模块？需要哪些消融证据？',
      hints: ['先按 sequence/depth/width/modality 分轴，不要按论文出现顺序背名词。', 'KDA 压缩历史为固定状态，MLA 保留逐 token latent KV；先比较信息与生命周期。', '约 2.5× 是架构、数据和训练的组合报告结果，没有消融不能单项归因。'],
      rubric: ['四轴、93 层与关键配置准确。', '递推、shape、数值和信息损失能互相解释。', 'AttnRes 与 token attention、QB dispatch 与 mixture weight 分清。', '主张带官方真源、消融需求和边界。'],
      exit: '闭卷用 90 秒解释 K3 架构，再给出一个全 KDA 和一个全 MLA 会更合理的反例场景。'
    },
    {
      id: 'k8-kimi-k3-agent-training', cluster: 'K8', title: 'Kimi K3 KK3-4：多教师 On-Policy 蒸馏与可验证 Agent 环境', kind: 'design', duration: 60, week: 5, prereqs: ['k8-kimi-k3-architecture', 'k8-agent-evaluation'],
      goal: '把 SFT、九个 domain/effort 教师、MOPD、partial rollout、Harness、AET、verifier 与 sandbox 组织成可诊断训练系统。', output: '训练 lineage + AET/Harness/verifier 图 + model/Harness 两组消融 + FDE 验收映射。',
      prompt: 'K3 为什么用多教师 on-policy distillation？怎样证明 Agent 能力来自模型提升，而不是只适配某个 Harness、judge 或公开 benchmark？',
      construct: '为一个企业 Agent 工作流定义 initial state、goal、tool action space、budget、public/hidden verifier 与人工升级；画 SFT→分域/分 effort RL→MOPD→QAT。设计 fixed Harness 换模型、fixed model 换 Harness、on/off-policy 与 judge/确定性 verifier 对照。',
      transfer: '新客户的工具、数据权限和失败成本与训练环境不同，但离线总分很高。怎样重切 pilot、发现 harness overfit、控制 reward hacking，并决定继续训练还是先修控制面？',
      hints: ['先把 model、teacher、Harness、environment、verifier 五个对象分开。', 'On-policy 解决 student 自己状态分布上的监督密度，不等于没有 policy lag。', '最终文字、最终环境状态、轨迹安全和业务采用是不同验收层。'],
      rubric: ['九教师坐标、MOPD 与 partial rollout 机制正确。', 'AET、权限、预算、verifier 与 sandbox 生命周期完整。', '消融能定位模型、Harness 或 judge 缺陷。', '能转化为 FDE pilot 的范围、门槛和残余风险。'],
      exit: '闭卷画出 model—Harness—environment—verifier 边界，并用两个对照实验归因一次 Agent 成功率提升。'
    },
    {
      id: 'k8-kimi-k3-serving-audit', cluster: 'K8', title: 'Kimi K3 KK3-5/6：混合缓存、百万上下文 Serving 与证据审计', kind: 'design', duration: 60, week: 6, prereqs: ['k8-kimi-k3-architecture', 'k8-kimi-k3-agent-training'],
      goal: '从状态一致性、内存、并发、故障域和 SLO 解释 KDA–MLA serving，并审计效率与榜单主张。', output: 'hybrid cache 状态机 + 四个故障 trace + request-class SLO + benchmark evidence card。',
      prompt: 'KDA state 固定、MLA KV 随 token 增长。怎样统一管理却保持不同语义，并在 prefix reuse、speculative decode、failover 与 1M burst 下守住正确性和 SLO？',
      construct: '画 physical page、512-token hash block 与 sparse KDA checkpoint；注入 checkpoint 缺组、共享快照误写、partial draft rejection、primary cluster failure 和百万 token burst。为短/长请求定义独立 admission budget，并按模型版本、effort、sampling、tools/Harness、日期和失败分母审计榜单。',
      transfer: '生产出现 cache hit 上升但 p95/成本恶化，且新 benchmark 总分提高但使用了不同 Harness。你如何按 model/kernel/scheduler/fleet 定位，并做 go/no-go、canary 或回滚？',
      hints: ['共用 paged pool 只统一 allocation/reference/eviction，不统一数据生命周期。', 'prefix hit 是 MLA hash endpoint 与全部 KDA group checkpoint 的交集。', '平均延迟会掩盖 1M 请求对短请求 TTFT 的挤压；按 request class 看预算和分母。'],
      rubric: ['混合缓存命中、copy-on-write、eviction 与 replay 正确。', 'affinity、secondary、admission control 和故障域清楚。', '性能按 prefill/decode/cache/流量与硬件分解。', '报告主张与独立验证、可比性限制和 FDE 承诺分开。'],
      exit: '不用图，3 分钟向面试官解释混合 cache 的三个不变量、两个故障门槛和一个你不会对客户做出的承诺。'
    },
    {
